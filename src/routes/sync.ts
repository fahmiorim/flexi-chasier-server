...
const transaksiSchema = z.object({
  ...
  potongan: z.number().int().nonnegative().default(0),
  biayaLayanan: z.number().int().nonnegative().default(0),
  pajak: z.number().int().nonnegative().default(0),
  status: z.string().default('Paid'),
  orderType: z.string().default('DineIn'),
        ...
        () =>
          tx.transaction.updateMany({
            ...
            data: {
              ...
              biayaLayanan: item.biayaLayanan,
              pajak: item.pajak,
              status: item.status,
...
const shiftKasSchema = z.object({
  ...
  saldoAkhir: z.number().int().nonnegative().nullable().optional(),
